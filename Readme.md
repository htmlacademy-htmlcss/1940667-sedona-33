...
* Студент: [Larisa Rylova](https://up.htmlacademy.ru/htmlcss/33/user/1940667).
* Наставник: `Андрей Грачев`.
* нажала куда-то и изменения удалились
---
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/1940667-sedona-33) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
